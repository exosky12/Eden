...
const productPageContainer = document.querySelector('.productPageContainer')
  ...
  newCard.innerHTML = `
    <img src="./assets/productPages/${products.id}_${name_pic(products.name)}.jpg" alt=${products.name}>
    <button class="add-to-favorite">
    </button>  
    <h5>${products.name}</h5>
    <h6>${products.price} €</h6>`;
    productPageContainer.appendChild(newCard);