...
genderMale.addEventListener("click", () => {
  ...
  white.addEventListener("click", () => {
    const whiteProducts = products.filter((obj) =>
      obj.colors.includes("white")
    );
    productSection.innerHTML = "";
  ...
  black.addEventListener("click", () => {
    const blackProducts = products.filter((obj) =>
      obj.colors.includes("black")
    );
    productSection.innerHTML = "";
  ...
  brown.addEventListener("click", () => {
    const brownProducts = products.filter((obj) =>
      obj.colors.includes("brown")
    );
    productSection.innerHTML = "";
  ...
  green.addEventListener("click", () => {
    const greenProducts = products.filter((obj) =>
      obj.colors.includes("green")
    );
    productSection.innerHTML = "";
  ...
  yellow.addEventListener("click", () => {
    const yellowProducts = products.filter((obj) =>
      obj.colors.includes("yellow")
    );
    productSection.innerHTML = "";
  ...
  purple.addEventListener("click", () => {
    const purpleProducts = products.filter((obj) =>
      obj.colors.includes("purple")
    );
    productSection.innerHTML = "";
